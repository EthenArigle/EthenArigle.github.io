...
This repository publishes an English academic homepage at `https://ethenarigle.github.io` using GitHub Pages and Jekyll.
...
Push the `main` branch. In the repository settings, open **Pages**, select **Deploy from a branch**, and choose `main` and `/ (root)`.
